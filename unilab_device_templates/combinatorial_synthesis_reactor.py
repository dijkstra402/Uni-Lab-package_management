"""
组合合成反应仪 — 标准设备类模板 (Device Class Template)
...
class CombinatorialSynthesisReactor:
    ...
    def __init__(self, device_id: Optional[str] = None, config: Optional[Dict[str, Any]] = None, **kwargs):
        ...
        Args:
            ...
            config[设备配置]: 设备启动配置。
        """
        self.device_id = device_id or "combinatorial_synthesis_reactor"
    ...
    @property
    @topic_config()
    def current_station_number(self) -> int:
        """当前工位编号。"""
        return self.data.get("current_station_number", 0)
