"""
振荡金属浴 — 标准设备类模板 (Device Class Template)

定义「振荡金属浴」这一设备大类的标准动作(action)与状态属性(property)。
...
@device(
    id="shaking_metal_bath",
    category=["加热、制冷及空气净化与调节设备", "固体浴", "振荡金属浴"],
    description="振荡金属浴标准接口：同一大类跨品牌统一的动作与参数。",
    displayname="振荡金属浴",
)
class ShakingMetalBath:
    ...
    def __init__(self, device_id: Optional[str] = None, config: Optional[Dict[str, Any]] = None, **kwargs):
        ...
        Args:
            ...
            config[设备配置]: 设备启动配置。
        """
        self.device_id = device_id or "shaking_metal_bath"
