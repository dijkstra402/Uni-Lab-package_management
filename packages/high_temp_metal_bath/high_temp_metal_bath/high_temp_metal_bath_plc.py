"""
高温金属浴 — PLC(OPC UA) 交互驱动 (自动生成，请勿手改)

由 generate_plc_drivers.py 依据 device_templates_actions.csv 生成。
继承 OpcUaClientWithSubscription，把「高温金属浴」标准动作/属性映射为 PLC 节点读写：
...
@device(
    id="high_temp_metal_bath_plc",
    category=["加热、制冷及空气净化与调节设备", "固体浴", "高温金属浴"],
    description="高温金属浴 PLC(OPC UA) 交互驱动：动作映射为节点读写。",
    displayname="高温金属浴(PLC)",
)
class HighTempMetalBathPLC(OpcUaClientWithSubscription):
