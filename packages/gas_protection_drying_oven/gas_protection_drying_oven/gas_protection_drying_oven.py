"""
气体保护干燥箱 — 标准设备类模板 (Device Class Template)

定义「气体保护干燥箱」这一设备大类的标准动作(action)与状态属性(property)。
...
@device(
    id="gas_protection_drying_oven",
    category=["加热、制冷及空气净化与调节设备", "恒温箱及类似设备", "高温箱", "气体保护干燥箱"],
    description="气体保护干燥箱标准接口：同一大类跨品牌统一的动作与参数。",
    displayname="气体保护干燥箱",
)
class GasProtectionDryingOven:
    ...
    def __init__(self, device_id: Optional[str] = None, config: Optional[Dict[str, Any]] = None, **kwargs):
        ...
        Args:
            ...
            config[设备配置]: 设备启动配置。
        """
        self.device_id = device_id or "gas_protection_drying_oven"
    ...
    def set_gas_concentration(self, gas_concentration: float = 0.0) -> Dict[str, Any]:
        ...
        Args:
            gas_concentration[气体浓度]: 目标气体浓度（单位依设备量程而定）。
        """
        raise NotImplementedError("请在设备包中实现该动作")
    ...
    def current_gas_concentration(self) -> float:
        """实际气体浓度。"""
        return self.data.get("current_gas_concentration", 0.0)
